...
if not opt['load']:
    ...
    for param_tensor in trainer.gen.state_dict():
        print(param_tensor, "\t", trainer.gen.state_dict()[param_tensor].size())
    print("Discriminator's state_dict:")
    for param_tensor in trainer.dis.state_dict():
        print(param_tensor, "\t", trainer.dis.state_dict()[param_tensor].size())    
